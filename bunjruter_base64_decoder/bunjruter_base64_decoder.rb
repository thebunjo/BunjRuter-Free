...
root.title("Bunjruter - Base64 Decoder")
root.resizable(false, false)
root.iconphoto(root_icon)

# Label Frame
root_label_frame = TkLabelFrame.new(root, text: "Base64 Decoder", font: custom_font, relief: 'raised', borderwidth: 1)
...
decrypt_button = TkButton.new(root) do
  ...
  place(x: 100, y:130)
  command do
    text_to_encoded = entry_text.get
    encoded_text = Base64.decode64(text_to_encoded)
